...
def get_retry_decorator(
    operation: str,
    max_attempts: int,
    wait_exponential_multiplier_seconds: int,
    retry_on_result: Callable,
) -> Callable:
    """
    ...
    def print_exception_and_traceback(exception: Exception) -> bool:
        ...
        return not isinstance(exception, KeyboardInterrupt) and not isinstance(
...
def retry_if_request_failed(
    result: Union[RequestResult, TokenizationRequestResult]
) -> bool:
